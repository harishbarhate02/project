...
//   final _Courses = <course>[]; // List to store rooms
...
//   }
//
//   Future<void> addCourse(course c1) async {
//     String? userId = FirebaseAuth.instance.currentUser?.uid;
...
//   }
//
//   Future<void> _editCourse(course c1) async {
//     String? userId = FirebaseAuth.instance.currentUser?.uid;
//     await _firestore
//         .collection('users')
//         .doc(userId)
...
//   }
//
//   Future<void> _deleteCourse(course c1) async {
//     String? userId = FirebaseAuth.instance.currentUser?.uid;
//     await _firestore
//         .collection('users')
//         .doc(userId)
