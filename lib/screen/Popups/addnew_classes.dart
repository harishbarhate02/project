...
class _AddClassScreenState extends State<AddClassScreen> {
      ...
      actions: <Widget>[
        ...
        ElevatedButton(
          onPressed: () {
            ...
            // Add logic to save class details
            // For example: call a function to handle the data
            saveClassDetails(name, strength, className, course);
  ...
  void saveClassDetails(
      String name, int strength, String className, String course) {
    // Implement your logic here to save class details
    // This could be API calls, database operations, etc.
    // print('Name: $name, Strength: $strength, Class Name: $className, Course: $course');
  }
}
